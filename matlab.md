...
`plot(X1,Y1,LineSpec1,...,Xn,Yn,LineSpecn)` | пары (X, Y) - массивы точке x и y соответственно, массивы должны быть одной размерности, LineSpec - спецификации графиков | Нарисовать график по точкам ![](https://studfiles.net/html/2706/180/html_ZFFGiK9tl1.zkje/img-NjV5oM.png "")
...
`mesh(X,Y,Z)` | Массивы точек | Нарисовать трехмерную поверхность, окраска зависит от значений ![](https://studfiles.net/html/2706/180/html_ZFFGiK9tl1.zkje/img-Mqj8Q2.png "")
`stairs(x,y)` | массивы переменных |  график в виде ступенчатой линии
`loglog(x, y)` | массивы переменных | логарифмический масштаб
`polar(phi,r)` | массивы переменных | полярные координаты ![](https://studfiles.net/html/2706/180/html_ZFFGiK9tl1.zkje/img-tYxXi6.png "")
