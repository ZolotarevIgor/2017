...
1. Округление и остаток от деления
...
1. Операции с массивами - нумерация начинается с 0
...
1. Работа со специальными значениями
